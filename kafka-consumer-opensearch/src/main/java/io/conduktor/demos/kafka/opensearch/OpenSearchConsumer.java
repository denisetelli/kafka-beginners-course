...
public class OpenSearchConsumer {
    ...
    private static KafkaConsumer<String, String> createKafkaConsumer() {
        ...
        // *** this property is used when the autocommit is not configured to true - the commit "manually" code is after the 'for' loop ***
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (openSearchClient; consumer) {
            ...
            while (true) {
                ...
                //in the while true, after receiving some records, we are consuming these records and inserting them in the OpenSearch
                //so, after the whole batch is consumed we can commit offsets
                // *** this code is used when the autocommit property (line 79) is configured to false ***
                consumer.commitSync();
